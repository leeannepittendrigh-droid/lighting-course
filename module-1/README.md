...
The total amount of visible light emitted by a source in all directions.

**Why it matters:** This is the true measurement of brightness. When LED replaced incandescent bulbs, we had to stop thinking in watts and start thinking in lumens.
...
The amount of electrical power the fixture uses.
...
Lumens divided by watts. This tells you how efficient a fixture is.
...
The amount of light falling on a surface. This is how we measure if a space has enough light.

> **Note:** Lux is the metric equivalent. **1 foot-candle ≈ 10.76 lux.**

### IES Recommended Lighting Levels

The **Illuminating Engineering Society (IES)** is the recognized technical authority on lighting in North America.
...
The "warmth" or "coolness" of white light, measured in Kelvin (K).
...
A scale from 0–100 measuring how accurately colors appear under a light source compared to natural sunlight.
...
- Dimmable — compatible with controls
- No mercury — environmentally friendly
- Cold weather performance — works in freezing temperatures
- Rebate eligible — qualifies for utility incentives

**Real-world lifespan context:** A warehouse running lights 12 hrs/day:
- 50,000 hours = **11.4 years**
- 100,000 hours = **22.8 years**

> 💡 **Sales Positioning:** LED is the only technology we recommend for new installations and replacements. The question isn't "should we use LED?" but "which LED products best fit your needs?"
...
**Common types:** T12 (obsolete), T8 (still common), T5 (more efficient)
...
> 💡 **Sales opportunity:** A 400W metal halide (32,000 lm) replaced by a 150W LED (same lumens) = **250 watts saved per fixture**. On 100 fixtures = 25 kW saved every hour they run.

---

## Lesson 3: Fixture Categories

### Indoor Fixtures

#### 1. Troffers
Recessed fixtures that fit into drop ceiling grids. The most common fixture type in commercial buildings.

**Common sizes:** 2×4 ft (most common), 2×2 ft, 1×4 ft

**Types:**
- **Volumetric (prismatic lens)** — Traditional look, most cost-effective
- **Backlit (edge-lit)** — Thin profile, modern appearance
- **Direct/Indirect** — Light goes both up and down, reduces glare
...
Surface-mounted or suspended ultra-thin fixtures. More mounting flexibility than troffers — no ceiling grid needed.

**Mounting options:** Recessed, surface mount, suspended
...
**Types:** UFO (round, most popular), Linear (for aisles), Traditional bell-shaped
...
#### 4. Linear Strip Fixtures
Long, narrow fixtures for continuous lighting.

**Types:**
- **Wraparound** — Basic enclosed, general use
...
#### 9. Canopy Lights
Surface-mounted for canopies and overhangs. Often operate 24/7/365.

**Critical ratings:**
- **IP65/66** — Weatherproofing (rain, dust, temperature extremes)
- **IK08/10** — Impact resistance (vehicles, equipment, vandalism)

> ⚠️ Never compromise on quality for canopy lights. The cost of failures far exceeds savings on cheap fixtures.
...
#### 10. Exit Signs
Required in every commercial building. Must be visible from 100 feet.
